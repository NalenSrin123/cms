                        ...
                        <div class="wrap-center">
                            <?php 
                               session_start();
                                ...
                                $selectUser="SELECT `user_name`,`profile` FROM `tbusers` WHERE `email`='$email'";
                                $res=$con->query($selectUser);
                                if($res->num_rows>0){
                                    $user=$res->fetch_assoc();
                                    echo '
                                        <img width="60" src="./assets/image/'.$user['profile'].'" alt="">
                        ...
                        <div class="wrap-bottom">
                            <ul>
                                ...
                                <li class="parent">
                                    ...
                                    <ul class="child">
                                        <li>
                                            <a href="../article/index.php">Website</a>
