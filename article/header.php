        ...
        <div class="container">
            ...
            session_start();
                if(empty($_SESSION['is_login'])){
                    echo ' <div class="auth">
                                <button class="btn btn-primary"><a style="color: #fff;" href="../admin/login.php">Sign In</a></button>
                                <button class="btn btn-danger"><a style="color: #fff;" href="../admin/register.php">Sign Up</a></button>
                            </div> ';
                }else{
                    echo ' <div class="auth">
                                <button class="btn btn-danger"><a style="color: #fff;" href="">Sign Out</a></button>
                            </div> ';
                }
            ?>    
